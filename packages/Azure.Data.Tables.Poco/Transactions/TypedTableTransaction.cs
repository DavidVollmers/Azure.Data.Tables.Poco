...
internal sealed class TypedTableTransaction<T> : ITypedTableTransaction<T> where T : class
{
    ...
    public TypedTableTransaction(TableClient tableClient, TableEntityConverter<T> tableEntityConverter)
    {
